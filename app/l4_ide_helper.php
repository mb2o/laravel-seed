 ...
 * @method static \Illuminate\Database\Query where(string $column, string $operator = null, mixed $value = null, string $connector = 'AND')
 * @method static \Illuminate\Database\Query where_in(string $column, array $values, string $connector = 'AND', boolean $not = false)
 * @method static \Illuminate\Database\Query with(string $column)
 * @method static \Illuminate\Database\Query order_by(string $column, string $direction = 'asc')
 * @method static \Illuminate\Database\Query take(int $value)
 * @method static \Illuminate\Database\Query select(array $columns = array('*'))
 * @method static \Illuminate\Database\Query join(string $table, string $column1, string $operator = null, string $column2 = null, string $type = 'INNER')
